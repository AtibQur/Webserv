...
// int Request::parseRequest(std::string request, ssize_t post)
// {
...
// std::string Request::decodePercentEncoding(const std::string &encoded)
// {
//     std::string decoded{};
...
// std::string Request::urlEncode(const std::string &input)
// {
...
// char Request::hexToChar(const std::string &hex)
// {
//     int value{};
//     std::stringstream ss{};
...
// bool Request::checkForSpaces(std::string fileNameBody)
// {
...
// bool Request::checkRequestLine(std::string httpRequest)
// {
...
// bool Request::checkMethod(std::string tmp)
// {
